...
public class No38_外观数列 {
    ...
    public static void main(String[] args) {
        Solution381 solution = new Solution381();
...
class Solution381 {
    ...
    public String countAndSay(String value, int n) {
        if (n == 1) {
            return value;
        }
        ...
        for (int i = 0; i < length; i++) {
            ...
            stringBuilder.append(counter).append(last);
            last = item;
            counter = 0;
            i--;
        }
        ...
        return countAndSay(stringBuilder.toString(), n - 1);
    }
}
